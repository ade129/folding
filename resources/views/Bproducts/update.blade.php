...
<section>
    ...
    <section class="content">
            ...
            <div class="box">
              ...
              <div class="box-body">
                {{ Form::open(array('url' => 'bestproducts/update/'.$Bproducts->idbestproducts, 'class' => 'form-horizontal', 'files' => 'true')) }}
                <div class="form-group">
                  <label class="col-sm-2 control-label">Name</label>
                  <div class="col-sm-5">
                    <!-- {{-- name:name untuk melempar controller ke database --}} -->
                  <input type="text" class="form-control" value="{{$Bproducts->name}}" name="name" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                    <textarea name="description" rows="3" id="description" class="form-control" required>{{$Bproducts->description}}</textarea>
                    </div>
                  </div>
