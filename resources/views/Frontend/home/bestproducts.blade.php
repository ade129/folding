   ...
   <html lang="zxx">
      ...
      <body>
         ...
         <section class="banner-bottom py-lg-5 py-3">
            ...
            {{ Form::open(array('url' => 'home/bestproducts/'.$bestproducts->slug, 'class' => 'form-horizontal','files' => 'true')) }}
            <div class="inner-sec-shop pt-lg-4 pt-3">
                    ...
                    <div class="col-lg-4 single-right-left ">
                        ...
                        <div class="flexslider1">
                            ...
                            <li data-thumb="images/f2.jpg">
                                <div class="thumb-image"> <img src="@if(!is_null($bestproducts->images)){{asset('porducts_images')}}/{{$bestproducts->images}}@endif" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                            </li>
                            </ul>
                ...
                <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                    ...
                    <p>Jenis : <span class="item_price">{{$bestproducts->jenis}}</span>
                    <p>Type : <span class="item_price">{{$bestproducts->type}}</span>
                    <!--/tabs-->
                            ...
                            <div class="resp-tabs-container">
                                ...
                                <div class="tab1">
                                    <div class="single_page">
                                        ...
                                        <p class="para">{{$bestproducts->description}}
                                        </p>
                                     </div>
                                  </div>
                                  <!--//tab_one-->
