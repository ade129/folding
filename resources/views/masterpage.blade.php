...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>CV.</b> INDOTEHNIK</span>
      <!-- logo for regular state and mobile devices -->
      <span href="indotehnik.com" class="logo-lg"><b>CV.</b> INDOTEHNIK</span>
    </a>
              ...
              @if (Auth::user()->role_type == "GA")
                  <li class="treeview" id="menu_master">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_categories"><a href="{{url('categories')}}"><i class="fa fa-cube"></i> Add Categories</a></li>
                      </ul>
                  </li>
                  
                @endif                
                <li id="menu_products"><a href="{{url('products/')}}"><i class="fa fa-cubes"></i> <span>Products</span></a></li>
                <li id="menu_abouts"><a href="{{url('abouts/')}}"><i class="fa fa-address-card"></i> <span>Abouts</span></a></li>
